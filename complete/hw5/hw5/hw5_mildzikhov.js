...
describe('HW5_Task1_Oleg_Mildzikhov ФИЛЬТРАЦИЯ ПО ЦЕНЕ', function() {
    ...
    it("Применен фильтр по ценам", () => {
        ...
        phonesPage.waitForFilterByBrand();
        //Не придумал, что на этом шаге можно толком проверить, если попадание цен проверяем в следующем
    });
...
describe('HW5_Task2_Oleg_Mildzikhov СОРТИРОВКА ПО ЦЕНЕ', function() {
    ...
    it("Применена сортировка по ценам", () => {
        ...
        phonesPage.waitForFilterByBrand();
        //Аналогично, не придумал, что на этом шаге можно толком проверить, если цены проверяем в следующем
    });
